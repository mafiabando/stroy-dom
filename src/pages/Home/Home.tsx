...
const subCategories = {
  ...
  "Гидроизоляция": ["Сухая смесь", "Жидкая гидроизоляция", "Лента гидроизоляционная"],
  ...
  "Инструменты и расходные материалы": ["Валики", "Шпатели", "Кисти", "Ленты и скотчи", "СВП", "Свёрла, биты и буры", "Абразивные диски", "Тара и ёмкости", "Другое"]
} as const;
