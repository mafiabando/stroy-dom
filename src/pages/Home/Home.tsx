...
const subCategories = {
  ...
  "Сухие смеси": ["Штукатурка", "Шпатлёвка", "Смеси для пола", "Плиточный клей", "Штукатурно-клеевая смесь", "Монтажный клей", "Клей для блоков", "Цемент",],
  ...
  "Крепёж": ["Саморезы для гипсокартона", "Кровельные саморезы", "Гвозди", "Крепежные уголки"],
  "Отделка и расходные материалы": ["Грунтовка и бетоноконтакт", "Лакокрасочные материалы", "Монтажные пены и герметики", "Инструменты и расходные материалы"]
} as const;
